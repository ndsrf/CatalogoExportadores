...
namespace DrWatson.CatExp.Data.Infrastructura
{
    public class ProveedorRepositorios : IProveedorRepositorios
    {
        public ProveedorRepositorios(FactoriaRepositorios repositoryFactories)
        {
        ...
        /// </remarks>
        public IRepositorio<T> GetRepositoryForEntityType<T>() where T : class
        {
            return GetRepository<IRepositorio<T>>(
        ...
        /// </remarks>
        private FactoriaRepositorios _repositoryFactories;

...
namespace DrWatson.CatExp.Data.Infrastructura
{
    public class FactoriaRepositorios
    {
        ...
        /// </summary>
        private IDictionary<Type, Func<DbContext, object>> GetCatExpFactories()
        {
        ...
        {
            _repositoryFactories = GetCatExpFactories();
        }
        ...
        /// </remarks>
        public FactoriaRepositorios(IDictionary<Type, Func<DbContext, object>> factories)
        {
        ...
        {
            return dbContext => new EFRepositorio<T>(dbContext);
        }
